...
{
    public partial class TextMessageReport : System.Web.UI.Page
    {
        /// <summary>
        ...
        private void RenderReportModels()
        {
            try
            {
                ...
                parmarray[3] = new ReportParameter("MessageType", Convert.ToString(Session["Type"], CultureInfo.CurrentCulture), false);
