...
{
    public partial class AutoPayEnrollmentReport : System.Web.UI.Page
    {
        /// <summary>
        ...
        private void RenderReportModels()
        {
            try
            {
                ...
                parmarray[3] = new ReportParameter("ConfirmationNumber", Convert.ToString(Session["ConfirmationNumber"], CultureInfo.CurrentCulture), false);
                parmarray[4] = new ReportParameter("PaymentMethod", Convert.ToString(Session["PaymentMethod"], CultureInfo.CurrentCulture), false);
