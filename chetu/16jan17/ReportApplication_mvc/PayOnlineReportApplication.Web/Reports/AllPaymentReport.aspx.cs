...
{
    public partial class AllPaymentReport : System.Web.UI.Page
    {
        /// <summary>
        ...
        private void RenderReportModels()
        {
            try
            {
                ...
                ReportParameter[] parmarray = new ReportParameter[6];
                ...
                parmarray[5] = new ReportParameter("PaymentMethod", Convert.ToString(Session["PaymentMethod"], CultureInfo.CurrentCulture), false);
