<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchReport.aspx.cs" Inherits="MAFWeb.Reports.SearchReport" %>
...
<head runat="server">
    ...
    <style>
        ...
        .chrome table[id*="_13iT0"],.chrome table[id*="_9iT0"],.chrome table[id*="_7iT0"] {
        width:99.99%;
		table-layout:fixed;
        }
        body {
