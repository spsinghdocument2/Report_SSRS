<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChatLogReport.aspx.cs" Inherits="MAFWeb.Reports.ChatLogReport" %>
...
<head runat="server">
    ...
    <style>
        ...
        .chrome table[class*="_1_r18"] tbody tr td:last-child {
        width:20px;
        }
        body {
            margin:0;
