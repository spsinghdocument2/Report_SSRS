...
{
    public partial class DNDStatusReport : System.Web.UI.Page
    {
        /// <summary>
        ...
        private void RenderReportModels()
        {
            try
            {
                ...
                ReportParameter[] parmarray = new ReportParameter[4];
                parmarray[0] = new ReportParameter("Queue", Convert.ToString(Session["QueueNumber"], CultureInfo.CurrentCulture), false);
                parmarray[1] = new ReportParameter("ExtNum", Convert.ToString(Session["ExtNumber"], CultureInfo.CurrentCulture), false);
                parmarray[2] = new ReportParameter("fromDate", Convert.ToString(Session["FromDate"], CultureInfo.CurrentCulture), false);
                parmarray[3] = new ReportParameter("toDate", Convert.ToString(Session["ToDate"], CultureInfo.CurrentCulture), false);
