...
{
    public partial class PowerZoneReport : System.Web.UI.Page
    {
        /// <summary>
        ...
        private void RenderReportModels()
        {
            try
            {
                ...
                parmarray[1] = new ReportParameter("Zone1FromTime", Convert.ToString(Session["Zone1FromTime"], CultureInfo.CurrentCulture), false);
                parmarray[2] = new ReportParameter("Zone1ToTime", Convert.ToString(Session["Zone1ToTime"], CultureInfo.CurrentCulture), false);
                ...
                MyReportViewer.ServerReport.DisplayName = reportName + "_" + Convert.ToString(Session["Date"], CultureInfo.CurrentCulture).Replace('/', '_');
                ...
                MyReportViewer.ShowToolBar = !bool.Parse(Session["BigScreen"].ToString());
