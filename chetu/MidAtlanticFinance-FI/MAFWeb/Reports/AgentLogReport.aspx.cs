...
{
    public partial class AgentLogReport : System.Web.UI.Page
    {
        /// <summary>
        ...
        private void RenderReportModels()
        {
            try
            {
                ...
                parmarray[0] = new ReportParameter("ExtNum", Convert.ToString(Session["ExtNumber"], CultureInfo.CurrentCulture), false);
                ...
                parmarray[3] = new ReportParameter("inter", Convert.ToString(Session["IsInternal"], CultureInfo.CurrentCulture), false);
                parmarray[4] = new ReportParameter("VoiceMail", Convert.ToString(Session["HasVoiceMail"], CultureInfo.CurrentCulture), false);
