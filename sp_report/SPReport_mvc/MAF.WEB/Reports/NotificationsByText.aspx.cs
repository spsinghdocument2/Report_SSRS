...
namespace MAF.WEB.Reports
{
    public partial class NotificationsByText : System.Web.UI.Page
    {
        /// <summary>
        ...
        private void RenderReportModels()
        {
            try
            {
                ...
                parmarray[3] = new ReportParameter("Type", Convert.ToString(Session["Type"], CultureInfo.CurrentCulture), false);
                ...
                // MyReportViewer.ServerReport.ReportPath = "/" + "Report Project4" + "/" + reportName;  // Report Path
